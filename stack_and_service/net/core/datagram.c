...
{
	light_log(LIGHT_LOG_INFO,"skb_copy_datagram_iovec_failed %"PRIu64"\n",skb_copy_datagram_iovec_failed);
	light_log(LIGHT_LOG_INFO,"skb_copy_datagram_iovec_called %"PRIu64"\n",skb_copy_datagram_iovec_called);
	light_log(LIGHT_LOG_INFO,"skb_copy_csum_datagram_iovec_failed %"PRIu64"\n",skb_copy_csum_datagram_iovec_failed);
	light_log(LIGHT_LOG_INFO,"skb_copy_csum_datagram_iovec_called %"PRIu64"\n",skb_copy_csum_datagram_iovec_called);
}
